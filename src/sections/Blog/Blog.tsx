...
export default function Welcome() {
    ...
    function getPostsData() {
        fetch("https://dev.to/api/articles?username=vuedavi").then((res) => res.json()).then((data) => {
    ...
    function setCardHeight() {
        ...
        if (container && blogCard) {

            const containerHeight = document.getElementById("cardsContainer") ?. clientHeight
            blogCard.style.height = containerHeight + "px"
        }
    }
