<template>
  <nav class="w-full h-max px-8 lg:px-32 py-4 flex justify-end">
    <div class=" w-full hidden md:flex flex-row items-center justify-center">
      <router-link to="/" 
  ...
  <aside :class="{'closed': !asideStore.show, 'opened': asideStore.show}" class="fixed top-0 right-0 bg-zinc-900/50 backdrop-blur p-4 z-20 w-full h-full flex flex-col justify-between items-center">
    ...
    <span class="text-white/50">@2023</span>
  </aside>
