<template>
    <section class="BlogContainer">
        <div class="infoCard" data-aos="fade-right" data-aos-duration="800">
            <img :src="userData.profile_image" alt="Foto de perfil da dev.to">
            <h1 class="font-bold text-2xl">{{ userData.name }}</h1>
            ...
            <p class="text-center font-medium">{{ userData.summary }}</p>
        ...
        <div class="postsContainer" data-aos="fade-right" data-aos-duration="800" data-aos-delay="300">
            ...
            <div class="post"
                ...
                <img class="w-72" :src="post.cover_image" alt="">
...
<style scoped>
.BlogContainer{
    @apply w-full min-h-screen px-8 md:px-32 pt-14 flex flex-row gap-4 pb-8
}
.infoCard{
...
.post{
    @apply w-full flex flex-row gap-4 text-white hover:bg-zinc-800 p-2 rounded-md
}
