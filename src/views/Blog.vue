    ...
    <section class="BlogContainer">
        <div class="infoCard" data-aos="fade-right" data-aos-duration="800">
            ...
            <div class="flex flex-row gap-4">
                ...
                <span>|</span>
                <span class="flex flex-row items-center text-zinc-400">
                    <svg class="text-white" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 256 256">
                        <path fill="currentColor"
                            d="M206.13 75.92A57.79 57.79 0 0 0 201.2 29a6 6 0 0 0-5.2-3a57.77 57.77 0 0 0-47 24h-26a57.77 57.77 0 0 0-47-24a6 6 0 0 0-5.2 3a57.79 57.79 0 0 0-4.93 46.92A55.88 55.88 0 0 0 58 104v8a54.06 54.06 0 0 0 50.45 53.87A37.85 37.85 0 0 0 98 192v10H72a26 26 0 0 1-26-26a38 38 0 0 0-38-38a6 6 0 0 0 0 12a26 26 0 0 1 26 26a38 38 0 0 0 38 38h26v18a6 6 0 0 0 12 0v-40a26 26 0 0 1 52 0v40a6 6 0 0 0 12 0v-40a37.85 37.85 0 0 0-10.45-26.13A54.06 54.06 0 0 0 214 112v-8a55.88 55.88 0 0 0-7.87-28.08M202 112a42 42 0 0 1-42 42h-48a42 42 0 0 1-42-42v-8a43.86 43.86 0 0 1 7.3-23.69a6 6 0 0 0 .81-5.76a45.85 45.85 0 0 1 1.43-36.42a45.85 45.85 0 0 1 35.23 21.1a6 6 0 0 0 5.06 2.77h32.34a6 6 0 0 0 5.06-2.76a45.83 45.83 0 0 1 35.23-21.11a45.85 45.85 0 0 1 1.43 36.42a6 6 0 0 0 .79 5.74A43.78 43.78 0 0 1 202 104Z" />
                    </svg>
                    @webldavi
                </span>
            </div>
            <p class="text-center font-medium">Olá Devs!✌️Me chamo Luís Daví tenho 19 anos, sou desenvolvedor front-end
                junior 🚀</p>
        ...
        <div class="postsContainer" data-aos="fade-right" data-aos-duration="800" data-aos-delay="300">
            <div class="w-full flex flex-row justify-between">
                ...
                <a href="https://dev.to/webdavi" target="_blank"
                    ...
                    Ver Todos
                    <svg class="rotate-[-135deg]" xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                        viewBox="0 0 24 24">
                        <path fill="currentColor"
                            d="M11.5 15.392V6q0-.213.143-.357q.144-.143.357-.143t.357.143q.143.144.143.357v9.392l3.746-3.746q.14-.14.344-.15q.204-.01.364.15t.16.354q0 .194-.16.354l-4.389 4.388q-.242.243-.565.243q-.323 0-.565-.243l-4.389-4.388q-.14-.14-.15-.344q-.01-.204.15-.364t.354-.16q.194 0 .354.16z" />
                    </svg>
                </a>
            </div>
            <div class="post" v-for="(post, index) in postsList" :key="index" v-show="index <= 3">
...
<style scoped>
.BlogContainer {
    @apply w-full min-h-screen px-8 md:px-32 pt-14 flex flex-col items-center lg:items-start lg:justify-center lg:flex-row gap-4 pb-8
}

.infoCard {
    @apply w-max h-max p-2 border border-zinc-700 bg-zinc-800 rounded-md text-white flex flex-col gap-4 items-center justify-center relative pt-14 max-w-[20rem]
}

.infoCard>img {
    box-shadow: 0px 0px 0px 10px rgba(24,24,27,1);
    @apply rounded-full w-24 h-24 absolute -top-14
}

.postsContainer {
    @apply flex-1 h-max min-h-full p-4 border border-zinc-700 rounded-md flex flex-col gap-4
}

.post {
    @apply w-full flex flex-col sm:flex-row items-center gap-4 text-white hover:bg-zinc-800 p-2 rounded-md border-b border-zinc-800
}
